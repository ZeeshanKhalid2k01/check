<!doctype html>
    ...
    <!-- END -->
    <body>
        <h1 style="border: 1px solid black; background-color:rgb(40, 30, 89); text-align:center; color:aliceblue">Apply For Jobs</h1>
        <!--
        // ----------------------------------------------------------------
    ...
    @csrf
        ...
        <td><a href="{{URL::to('listscompany/save' , $company->id)}}"><button type="button" class="btn btn-danger">Apply</button></a></td> 
